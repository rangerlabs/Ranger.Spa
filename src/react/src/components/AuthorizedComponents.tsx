...
import Organization from './app/organization/OrganizationForm';
...
export const AuthorizedComponents: IAppRoute[] = [
    ...
    { exact: true, path: RoutePaths.Organization, component: Organization, breadcrumbPath: BreadcrumbPaths.Organization() },
