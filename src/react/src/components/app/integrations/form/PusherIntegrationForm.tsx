...
interface IPusherIntegrationFormProps extends WithStyles<typeof styles>, WithSnackbarProps {
    editIntegration: PusherIntegration;
...
const mapDispatchToProps = (dispatch: any) => {
    return {
        ...
        dispatchAddIntegration: (integration: PusherIntegration) => {
...
class PusherIntegrationForm extends React.Component<IPusherIntegrationFormProps> {
        ...
        return (
            <Formik
                ...
                onSubmit={(values: PusherIntegration, formikBag: FormikBag<FormikProps<PusherIntegration>, PusherIntegration>) => {
                    ...
                    newIntegration.appId = values.appId;
                    newIntegration.key = values.key;
                    newIntegration.secret = values.secret;
                    newIntegration.cluster = values.cluster;
                ...
                {(props) => (
                    <React.Fragment>
                        ...
                        <Typography className={classNames(classes.title, classes.paper)} align="left" variant="h5">
                            {this.props.editIntegration ? 'Edit Pusher Integration' : 'New Pusher Integration'}
                        </Typography>
                        <Paper className={classes.paper} elevation={3}>
                            ...
                            <form onSubmit={props.handleSubmit}>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item xs={12}>
                                        <FormikTextField
                                            infoText="The app_id provided by Pusher."
                                            name="appId"
                                            label="App Id"
                                    ...
                                    <Grid item xs={12}>
                                        <FormikTextField
                                            infoText="The key provided by Pusher."
                                            name="key"
                                            label="Key"
                                    ...
                                    <Grid item xs={12}>
                                        <FormikTextField
                                            infoText="The secret provided by Pusher."
                                            name="secret"
                                            label="Secret"
                                    ...
                                    <Grid item xs={12}>
                                        <FormikTextField
                                            infoText="The Pusher cluster."
                                            name="cluster"
                                            label="Cluster"
                                            value={props.values.cluster}
                                            errorText={props.errors.cluster}
                                            touched={props.touched.cluster}
                                            onChange={props.handleChange}
                                            onBlur={props.handleBlur}
                                            autoComplete="off"
                                            required
                        ...
                        {this.props.editIntegration && this.props.canEdit && (
...
export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withSnackbar(integrationForm(PusherIntegrationForm))));
