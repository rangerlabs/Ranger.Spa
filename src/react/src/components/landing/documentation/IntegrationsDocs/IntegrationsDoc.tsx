        ...
        <React.Fragment>
            ...
            <Block>
                ...
                <Paragraph>
                    ...
                    your Breadcrumb events. For example, if two Breadcrumbs are sent almost immediately after one another, it is possible your system receives
                    the <Bold>DWELLING</Bold> event before the <Bold>ENTERED</Bold> event.
                </Paragraph>
            ...
            <Block>
                <Paragraph>
                    To validate the authenticity of a Webhook event, the Id is signed with the HMAC-SHA1 algorithm using the Signing Key available on the
                    Integration's details page. The event signature is found on the Webhook request's <Bold>x-ranger-signature</Bold> header.
                </Paragraph>
            </Block>
        </React.Fragment>
    );
